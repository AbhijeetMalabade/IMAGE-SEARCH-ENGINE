const apiKey = "xMbVJpoG2LJDnRlvJCCHbk3ABVVg6XgtYtg6CehdtfihsioVMkOs6ubZ";
      ...
      (
        img
          ...
          <div class="details">
            ...
            <button onclick="downloadImg('${img.src.large2x}');event.stopPropogation();"><i class="fa-solid fa-download"></i></i></button>
          </div>
        </li>`
    )
    .join("");
